...
class API {
    ...
    private function listRiceCategory(){
        $this->client->findRiceCategory();
    }
    private function listVegitableCategory(){
        $this->client->findAllVegitable();
    }
     private function listSPNCategory(){
        $this->client->findspncategory();
    }
     private function listPlCategory(){
        $this->client->findPlcategory();
    }
     private function listFnMCategory(){
        $this->client->findFnMcategory();
    }
    private function listRices(){
        $this->client->findrice();
    }
     private function listPlasticItems(){
        $this->client->findrice();
    }
    private function listSpnItems(){
        $this->client->findSPNItems();
    }
    private function listweeklyorder(){
        $this->client->findworders();
    }
    private function listdailyorder(){
        $this->client->finddorders();
    }
    private function listallvegetables(){
        $this->client->findVegitables();
    }
      private function listallfnm(){
        $this->client->findFnM();
    }
   private function listOthers(){
        $this->client->findOthers();
    }
