...
class Category extends REST{
	...
	public function findAllForClient(){
		$query="SELECT * FROM category c WHERE type=0 ORDER BY c.priority ASC";
		return $this->db->get_list($query);
	}
    public function findAllRice(){
	$query="SELECT * FROM category c WHERE type=1";
		return $this->db->get_list($query);
	}
	public function findAllVegitable(){
	$query="SELECT * FROM category c WHERE type=2";
		return $this->db->get_list($query);
	}
	public function findAllspncategory(){
	$query="SELECT * FROM category c WHERE type=3";
		return $this->db->get_list($query);
	}
	public function findAllplasticcategory(){
	$query="SELECT * FROM category c WHERE type=4";
		return $this->db->get_list($query);
	}
	public function findAllFnMcategory(){
	$query="SELECT * FROM category c WHERE type=5";
		return $this->db->get_list($query);
	}
